			...
			{copy && (
				...
				>
					<Button
						...
						startIcon={<SvgIcon>lucide:clipboard</SvgIcon>}
					>
						Copy
					</Button>
				</Tooltip>
...
function trimCode(children: HighlightProps['children']) {
...
const StyledHighlight = styled(Highlight)`` as unknown as typeof Highlight;
