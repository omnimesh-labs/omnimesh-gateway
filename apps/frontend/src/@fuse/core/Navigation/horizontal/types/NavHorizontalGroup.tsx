...
type NavHorizontalGroupProps = NavItemComponentProps;

/**
 * NavHorizontalGroup.
 * Represents a horizontal group component used in the  navigation navigation list.
...
const NavHorizontalGroupWithMemo = memo(NavHorizontalGroup);
