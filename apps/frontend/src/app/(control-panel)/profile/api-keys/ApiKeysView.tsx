...
import { authApi, ApiKey as ApiKeyType, CreateApiKeyRequest } from '@/lib/api';
	...
	const columns = useMemo<MRT_ColumnDef<ApiKey>[]>(() => [
		...
		},
		{
			...
			Cell: ({ cell }) => {
				...
				if (!lastUsed) return <Typography variant="body2" color="textSecondary">Never</Typography>;
			...
			content={
				<div className="p-6">
					...
					>
							...
							<Stack spacing={3}>
								<Alert severity="warning">
									<Typography variant="body2" gutterBottom>
										<strong>This key will only be shown once.</strong> Please copy and save it securely.
									</Typography>
									<Typography variant="body2">
								...
								<Box>
									...
									>
										<Box className="flex items-center justify-between">
											<Typography 
												variant="body2" 
												className="font-mono break-all text-yellow-800"
											>
												{createdKey}
											</Typography>
											<IconButton 
						...
						<DialogActions>
							<Button onClick={() => setKeyCreatedModalOpen(false)} variant="contained">
								I've Saved the Key
							</Button>
						</DialogActions>
					</Dialog>
